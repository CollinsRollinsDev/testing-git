...
@import url('https://fonts.googleapis.com/css2?family=Acme&display=swap');
      ...
      <section className={styles.container}>
        <section className={styles.left}>
          <div data-aos="fade-left" className={styles.greet}>
            Greetings,
          </div>
          <div data-aos="fade-right" className={styles.offer}>
            <p>
              I am{" "}
          ...
          <div data-aos="fade-left" className={styles.shortSpech}>
            <p>I am passionate about coding and that has enabled me to discover a career in the IT industry as a software engineer.
